...
- More documentation regarding the Hilma SDK versioning and API usage coming soon
...
## Test Release Calendar
- A calendar with test release dates would help plan future developments with integration partners
- Will be talked about internally and we aim to deliver this during 2026
